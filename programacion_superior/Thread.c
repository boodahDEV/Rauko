...
void main(int argc, char const *argv[])
{
   ...
   pthread_t hilos[tam];
    pthread_t hilo2;
    pthread_create(&hilo1,NULL,saludo,(void *)cadena); // La Funcion pthread_create tiene 4 argumentos, el primero es la referencia(&) del hilo, el segundo lo pongo nulo
